...
public:
    ...
    vector<Document> FindTopDocuments(const string& raw_query,
        DocumentPredicate sort_compare) const
    {
        const Query query = ParseQuery(raw_query);  // парсим строку на плюс и минус слова
        auto matched_documents = FindAllDocuments(query, sort_compare);   // находим документы с нужным статусом
